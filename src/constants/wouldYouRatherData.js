...
export const QUESTIONS = {
    ...
    funny: [
        ...
        { a: { en: "Smell like onions forever", ku: "هەتاهەتایی بۆنی پیازت لێ بێت" }, b: { en: "Have everything smell like onions", ku: "هەموو شتێک بۆنی پیازت لێ بدات" } },
        { a: { en: "Sneeze every 5 seconds", ku: "هەر ٥ چرکە بپژمیت" }, b: { en: "Hiccup every 5 seconds", ku: "هەر ٥ چرکە تووشی هیکە بیت" } },
        { a: { en: "Dance every time you hear music", ku: "هەر کات میوزیک ببیستیت سەما بکەیت" }, b: { en: "Sing every time you think", ku: "هەر کات بیر بکەیتەوە گۆرانی بڵێیت" } },
        { a: { en: "Have a banana for a nose", ku: "لووتت مۆز بێت" }, b: { en: "Have spaghetti for hair", ku: "قژت سپاگێتی بێت" } },
        { a: { en: "Talk like Yoda forever", ku: "هەتاهەتایی وەک یۆدا قسە بکەیت" }, b: { en: "Walk like a crab forever", ku: "هەتاهەتایی وەک قڕژاڵ ڕێ بکەیت" } },
        { a: { en: "Have a tail", ku: "کلکت هەبێت" }, b: { en: "Have an extra arm", ku: "دەستێکی زیادە هەبێت" } },
        { a: { en: "Sweat maple syrup", ku: "ئارەقی شیرەی دار بکەیت" }, b: { en: "Cry orange juice", ku: "شەربەتی پرتەقاڵت لە چاو بێت" } },
        { a: { en: "Speak in autotune", ku: "بە ئۆتۆتیون قسە بکەیت" }, b: { en: "Only communicate through song", ku: "تەنها بە گۆرانی پەیوەندی بکەیت" } },
        { a: { en: "Have a rewind sound when walking backwards", ku: "کاتێک پاشەوە ڕاتدەکات دەنگی گەڕانەوە لێ بدات" }, b: { en: "Have dramatic music when you enter a room", ku: "کاتێک دەچیتە ژوورەوە میوزیکی دراماتیک لێ بدات" } },
        { a: { en: "Always wear clown shoes", ku: "هەمیشە پێڵاوی کلاون بپۆشیت" }, b: { en: "Always wear a clown wig", ku: "هەمیشە قژی کلاون بپۆشیت" } },
        { a: { en: "Have a face on your belly", ku: "ڕووت لەسەر سکت بێت" }, b: { en: "Have hands for feet", ku: "دەستەکانت پێت بن" } },
        { a: { en: "Sound like a dolphin when you laugh", ku: "کاتێک دەپێکەنیت دەنگت وەک دۆڵفین بێت" }, b: { en: "Honk like a goose when you cry", ku: "کاتێک دەگریت دەنگت وەک قاز بێت" } },
        { a: { en: "Have elastic arms", ku: "دەستەکانت کەشێنراوەکان بن" }, b: { en: "Have bouncy legs", ku: "قاچەکانت فڕیۆکەکان بن" } },
        { a: { en: "Only be able to whisper", ku: "تەنها بتوانیت پسپسە بکەیت" }, b: { en: "Only be able to shout", ku: "تەنها بتوانیت هاوار بکەیت" } },
        { a: { en: "Have no elbows", ku: "ئانووکت نەبێت" }, b: { en: "Have no knees", ku: "ئەژنۆت نەبێت" } },
    ...
    extreme: [
        ...
        { a: { en: "Live your life over again as the opposite gender", ku: "ژیانت دووبارە بژیت وەک ڕەگەزی پێچەوانە" }, b: { en: "Live as yourself but 100 years ago", ku: "وەک خۆت بژیت بەڵام ١٠٠ ساڵ لەمەوبەر" } },
        { a: { en: "Give up all privacy forever", ku: "هەتاهەتایی هەموو تایبەتمەندیت لە دەست بدەیت" }, b: { en: "Give up the internet forever", ku: "هەتاهەتایی ئینتەرنێت لە دەست بدەیت" } },
        { a: { en: "Always be wrong about everything", ku: "هەموو کات هەڵە بیت لە هەموو شتێکدا" }, b: { en: "Always agree with everyone", ku: "هەموو کات ڕازی بیت لەگەڵ هەموان" } },
        ...
        { a: { en: "Never feel physical pain", ku: "هەرگیز ئازاری جەستەیی هەست پێ نەکەیت" }, b: { en: "Never feel emotional pain", ku: "هەرگیز ئازاری سۆزداری هەست پێ نەکەیت" } },
        { a: { en: "Know everyone's secrets", ku: "نهێنییەکانی هەموان بزانیت" }, b: { en: "Have everyone know yours", ku: "هەموان نهێنییەکانی تۆ بزانن" } },
        { a: { en: "Be reborn as someone in the past", ku: "لە ڕابردوودا وەک کەسێک دووبارە لەدایک ببیتەوە" }, b: { en: "Be reborn as someone in the future", ku: "لە داهاتوودا وەک کەسێک دووبارە لەدایک ببیتەوە" } },
        { a: { en: "Experience every fear at once", ku: "هەموو ترسەکان یەکجار ئەزموون بکەیت" }, b: { en: "Never feel fear again but never feel excitement", ku: "هەرگیز ترس هەست پێ نەکەیت بەڵام هەرگیز سەرسام نەبیت" } },
        { a: { en: "Know how you'll die but not when", ku: "بزانیت چۆن دەمریت بەڵام نەزانیت کەی" }, b: { en: "Know when you'll die but not how", ku: "بزانیت کەی دەمریت بەڵام نەزانیت چۆن" } },
...
export const getQuestionCount = (category) => {
    return (QUESTIONS[category] || QUESTIONS.fun).length;
};
