...
export const charadesData = {
    ...
    animals: [
        ...
        { word: { en: 'Bear', ku: 'ورچ' } },
        { word: { en: 'Tiger', ku: 'پڵنگ' } },
        { word: { en: 'Wolf', ku: 'گورگ' } },
        { word: { en: 'Zebra', ku: 'زێبرا' } },
        { word: { en: 'Rabbit', ku: 'کەروێشک' } },
        { word: { en: 'Fox', ku: 'ڕێوی' } },
        { word: { en: 'Shark', ku: 'قرش' } },
        { word: { en: 'Dolphin', ku: 'دۆلفین' } },
    ...
    jobs: [
        ...
        { word: { en: 'Dentist', ku: 'دکتۆری ددان' } },
        { word: { en: 'Lawyer', ku: 'پارێزەر' } },
        { word: { en: 'Actor', ku: 'ئەکتەر' } },
        { word: { en: 'Musician', ku: 'مۆسیقاژەن' } },
        { word: { en: 'Photographer', ku: 'وێنەگر' } },
    ...
    sports: [
        ...
        { word: { en: 'Badminton', ku: 'تۆپی پەڕ' } },
        { word: { en: 'Cricket', ku: 'کریکێت' } },
        { word: { en: 'Racing', ku: 'پێشبڕکێ' } },
