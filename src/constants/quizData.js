...
export const QUIZ_CATEGORIES = {
    ...
    music: {
        ...
        questions: [
            ...
            { question: { en: "What genre is Taylor Swift mainly known for?", ku: "تەیلۆر سویفت بۆ کام جۆنر زۆرترین ناسراوە؟" }, options: [{ en: "Rock", ku: "ڕۆک" }, { en: "Pop/Country", ku: "پۆپ/کاونتری" }, { en: "Jazz", ku: "جاز" }, { en: "Classical", ku: "کلاسیکی" }], answer: 1 },
            { question: { en: "What rapper's real name is Marshall Mathers?", ku: "ناوی ڕاستەقینەی کام ڕاپەر مارشاڵ ماسەرزە؟" }, options: [{ en: "Jay-Z", ku: "جەی زی" }, { en: "Eminem", ku: "ئێمینێم" }, { en: "Drake", ku: "درەیک" }, { en: "Kanye", ku: "کانیە" }], answer: 1 },
            { question: { en: "Which instrument is smallest in a standard orchestra?", ku: "کام ئامێر بچووکترین لە ئۆرکێستراکەدا؟" }, options: [{ en: "Piccolo", ku: "پیکۆلۆ" }, { en: "Violin", ku: "ڤایۆلین" }, { en: "Flute", ku: "فلووت" }, { en: "Clarinet", ku: "کلارینێت" }], answer: 0 },
            { question: { en: "What does 'fortissimo' mean in music?", ku: "فۆرتیسیمۆ لە میوزیکدا چی واتایە؟" }, options: [{ en: "Very soft", ku: "زۆر نەرم" }, { en: "Very loud", ku: "زۆر بەرز" }, { en: "Medium", ku: "ناوەندی" }, { en: "Silent", ku: "بێدەنگ" }], answer: 1 },
            { question: { en: "Who is known as the 'Queen of Pop'?", ku: "کێ بە 'شاژنی پۆپ' ناسراوە؟" }, options: [{ en: "Beyoncé", ku: "بیۆنسێ" }, { en: "Madonna", ku: "مادۆنا" }, { en: "Lady Gaga", ku: "لەیدی گاگا" }, { en: "Rihanna", ku: "ڕیهانا" }], answer: 1 }
        ]
    },
    technology: {
        name: { en: 'Technology', ku: 'تەکنەلۆجیا' },
        icon: 'desktop',
        questions: [
            ...
            { question: { en: "What company makes Android?", ku: "کام کۆمپانیا ئەندرۆید دروست دەکات؟" }, options: [{ en: "Apple", ku: "ئەپڵ" }, { en: "Microsoft", ku: "مایکرۆسۆفت" }, { en: "Google", ku: "گووگڵ" }, { en: "Samsung", ku: "سامسونگ" }], answer: 2 },
            { question: { en: "What is the most used search engine?", ku: "بەکارهاتووترین مۆتۆری گەڕان چییە؟" }, options: [{ en: "Bing", ku: "بینگ" }, { en: "Google", ku: "گووگڵ" }, { en: "Yahoo", ku: "یاهوو" }, { en: "DuckDuckGo", ku: "دەک دەک گۆ" }], answer: 1 },
            { question: { en: "What does USB stand for?", ku: "USB بۆ چی دەوەستێت؟" }, options: [{ en: "Universal Serial Bus", ku: "ئۆتۆبوسی سیریالی گشتی" }, { en: "United System Board", ku: "تەختەی سیستەمی یەکگرتوو" }, { en: "Ultra Speed Byte", ku: "بایتی خێرایی زۆر" }, { en: "Universal System Backup", ku: "پاشکەوتی سیستەمی گشتی" }], answer: 0 }
        ]
    }
};
