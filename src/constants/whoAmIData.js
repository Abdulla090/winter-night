...
export const CATEGORIES = {
    ...
    historical: {
        ...
        items: [
            { en: 'Cleopatra', ku: 'کلیۆپاترا' },
            { en: 'Napoleon', ku: 'ناپلیۆن' },
            { en: 'Alexander the Great', ku: 'ئەسکەندەری گەورە' },
            { en: 'Julius Caesar', ku: 'یولیوس سیزار' },
            { en: 'Albert Einstein', ku: 'ئالبەرت ئایندشتاین' },
            { en: 'Leonardo da Vinci', ku: 'لیۆناردۆ داڤینچی' },
            { en: 'William Shakespeare', ku: 'ولیەم شێکسپیر' },
            { en: 'Abraham Lincoln', ku: 'ئەبراهام لینکۆڵن' },
            { en: 'Mahatma Gandhi', ku: 'مەهاتما گاندی' },
            { en: 'Nelson Mandela', ku: 'نێلسن ماندێلا' },
            { en: 'Marie Curie', ku: 'ماری کوری' },
            { en: 'Mozart', ku: 'مۆزارت' },
            { en: 'Saladin', ku: 'سەلاحەدین' },
            { en: 'Genghis Khan', ku: 'جەنگیز خان' },
            { en: 'Queen Victoria', ku: 'شاژن ڤیکتۆریا' },
        ],
    },
    foodDrinks: {
