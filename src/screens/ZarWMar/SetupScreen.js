...
import { Dices, Play, Users } from 'lucide-react-native';
...
export default function ZarWMarSetupScreen({ navigation }) {
    ...
    const startGame = () => {
        ...
        navigation.navigate('ZarWMarPlay', { players });
    };
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 120 }}>
                ...
                >
                    <View style={[styles.heroIcon, { backgroundColor: '#10B98120' }]}>
                        <Dices size={48} color="#10B981" strokeWidth={1.5} />
                    </View>
                </MotiView>
                ...
                <GlassCard style={{ marginBottom: layout.spacing.lg }}>
                    <View style={[styles.sectionHeader, { flexDirection: rowDirection }]}>
                        <Users size={18} color="#10B981" style={{ marginHorizontal: 8 }} />
