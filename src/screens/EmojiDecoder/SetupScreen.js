...
import { ArrowLeft, ArrowRight, MessageSquare } from 'lucide-react-native';
            ...
            <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
                ...
                <GlassCard style={{ marginBottom: layout.spacing.xl }}>
                    ...
                    <Text style={[styles.instructionText, { color: colors.text.secondary }, isKurdish && styles.kurdishFont]}>
                        {t('emojiDecoder.description', language)}
                    </Text>
                </GlassCard>
                ...
                <View style={{ gap: layout.spacing.md }}>
                    {emojiCategories.map((category, index) => (
                        ...
                        >
                            <BeastButton
                                variant="secondary" // Use secondary for category options for a 'card-like' feel
                                title={category.title[language]} // Ensure data structure matches
...
const styles = StyleSheet.create({
    ...
    kurdishFont: {
        fontFamily: 'Rabar_022', // Assuming 'Rabar_022' is the correct font name based on previous files, or standard 'Rabar'
    }
});
